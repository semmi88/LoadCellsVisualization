...
/**
 * Created by endre on 8/9/2015.
 */
public class FakePortConnectionFactory implements PortConnectionFactory {
    @Override
    public SerialPort createPortConnection(PortConfiguration portConfiguration) {
        System.out.println("Fake port connection " + portConfiguration.getBaudRate());
